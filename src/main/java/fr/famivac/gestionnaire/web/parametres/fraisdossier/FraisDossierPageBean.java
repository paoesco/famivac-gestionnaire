...
public class FraisDossierPageBean implements Serializable {
  ...
  @Inject private FraisDossierService service;
  ...
  public void create() {
    ...
    FacesMessage message =
        new FacesMessage(FacesMessage.SEVERITY_INFO, "Le frais dossier a été ajouté", null);
  ...
  public void supprimer(Long id) {
    service.delete(id);
    FacesMessage message =
        new FacesMessage(FacesMessage.SEVERITY_INFO, "Le frais dossier a été supprimé", null);
    FacesContext.getCurrentInstance().addMessage(null, message);
    init();
  }
