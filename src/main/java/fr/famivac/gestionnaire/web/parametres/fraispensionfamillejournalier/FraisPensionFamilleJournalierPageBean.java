...
public class FraisPensionFamilleJournalierPageBean implements Serializable {
  ...
  @Inject private FraisPensionFamilleJournalierService service;
  ...
  public void create() {
    ...
    FacesMessage message =
        new FacesMessage(
            FacesMessage.SEVERITY_INFO, "Le frais pension famille journalier a été ajouté", null);
  ...
  public void supprimer(Long id) {
    ...
    FacesMessage message =
        new FacesMessage(
            FacesMessage.SEVERITY_INFO, "Le frais pension famille journalier a été supprimé", null);
    FacesContext.getCurrentInstance().addMessage(null, message);
    init();
  }
