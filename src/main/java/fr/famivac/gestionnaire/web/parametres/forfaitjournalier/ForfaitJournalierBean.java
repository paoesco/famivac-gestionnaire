...
public class ForfaitJournalierBean implements Serializable {
  ...
  @Inject private ForfaitJournalierService forfaitJournalierService;
  ...
  public void create() {
    ...
    FacesMessage message =
        new FacesMessage(FacesMessage.SEVERITY_INFO, "Le tarif a été ajouté", null);
  ...
  public void supprimer(Long id) {
    ...
    FacesMessage message =
        new FacesMessage(FacesMessage.SEVERITY_INFO, "Le tarif a été supprimé", null);
    FacesContext.getCurrentInstance().addMessage(null, message);
    init();
  }
