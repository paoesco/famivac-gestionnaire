...
@NamedQueries({
  @NamedQuery(
      name = FraisPensionFamilleJournalier.QUERY_LISTE_ALL,
      query = "select f from FraisPensionFamilleJournalier f"),
  @NamedQuery(
      name = FraisPensionFamilleJournalier.QUERY_GET_CURRENT,
      query =
          "select f from FraisPensionFamilleJournalier f where f.dateDebutValidite <= :date and :date <= f.dateFinValidite")
})
