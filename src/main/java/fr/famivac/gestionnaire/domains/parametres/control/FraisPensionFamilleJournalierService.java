...
public class FraisPensionFamilleJournalierService {
  ...
  public List<FraisPensionFamilleJournalier> retrieve() {
    return entityManager
        .createNamedQuery(
            FraisPensionFamilleJournalier.QUERY_LISTE_ALL, FraisPensionFamilleJournalier.class)
        .getResultList();
  }
  ...
  public void delete(Long id) {
    FraisPensionFamilleJournalier entity =
        entityManager.find(FraisPensionFamilleJournalier.class, id);
  ...
  public Optional<BigDecimal> getCurrentMontant(Date date) {
    try {
      return Optional.of(
          entityManager
              .createNamedQuery(
                  FraisPensionFamilleJournalier.QUERY_GET_CURRENT,
